...
validateOverlapsForGroups :: Overlaps -> Writer [ValidationRecord] ValidationResult
validateOverlapsForGroups overlaps' = do
  ...
  tell [ Info $ "### Checking integrity of overlaps file for "
